  ...
  return (
    <div>
      ...
      <div style={{paddingLeft:"100px",paddingTop:"50px",backgroundColor:"whitesmoke"}}>
            <h1 style={{textAlign:"center"}}>Students List</h1><br /><br />
            <Button onClick={()=>navigate('/stdregister')} sx={{backgroundColor:'blue',color:'white',marginBottom:"2px"}}>Add Student</Button>
