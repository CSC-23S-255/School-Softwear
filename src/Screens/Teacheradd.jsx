...
const Teacheradd = () => {
 ...
 const handletecherform = async (e)=>{
    e.preventDefault();
    ...
    try {
        const docRef = await addDoc(collection(database, "Teachers"),techerobj)
